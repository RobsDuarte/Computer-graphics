...
var headMatrix = new Matrix4()
  ...
  .rotate(joint.head, 0, 0, 1)
  

var motorBlobMatrix = new Matrix4()

.setTranslate(0, 0, 1)

.rotate(joint.motorBlob, 0, 0, 1);
...
//corpo
var torsoMatrixLocal = new Matrix4().setScale(2 , 25, 2);

//base
var shoulderMatrixLocal = new Matrix4().setScale(6, .5, 6);
//gerador
var armMatrixLocal = new Matrix4().setScale(4, 3, 6);
//gerador blob
var handMatrixLocal = new Matrix4().setScale(2, .5, 5);
//mooto
var headMatrixLocal = new Matrix4().setScale(1.5, 1.5, 1.5);
//Moto Blob
var motorBlobMatrixLocal = new Matrix4().setScale(0.5, 0.5, 0.5);
//blade
...
function handleKeyPress(event) {
  ...
  switch (ch) {
    ...
    case "t":
      ...
      torsoMatrix.setTranslate(0, -5, 0).rotate(joint.torso, 0, 1, 0);
    ...
    case "s":
      ...
      var currentShoulderRot = new Matrix4()
        ...
        .rotate(-joint.shoulder, 0, 1, 0)

        .translate(0, -2, 0);

      shoulderMatrix.setTranslate(0,-13, 0).multiply(currentShoulderRot);
    ...
    case "a":
      ...
      armMatrix.setTranslate(0, 13, -.5).multiply(currentArm);
    ...
    case "h":
      ...
      headMatrix.setTranslate(0, -2, 3).rotate(joint.head, 0, 0, 1);
    ...
    case "l":
      ...
      motorBlobMatrix.setTranslate(0, 0, 1).rotate(joint.motorBlob, 0, 0, 1);
...
function draw(useRotator = true) {
  ...
  // MotorBlob
  s.push(new Matrix4(s.top()).multiply(motorBlobMatrix));
  renderCube(s, motorBlobMatrixLocal);
